...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/a.png);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-4x">Admin Panel Login</h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="submit" name="login" class="btn btn btn-block" value="login" >
								</form><br><br><br>
								Created by Rony Barua Protoy.........................
							</div>
						</div>
					</div>
				</div>
